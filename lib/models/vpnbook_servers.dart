...
class VPNBookServers {
  static const String _vpnBookUKConfig = '''client
dev tun3
proto tcp
remote 145.239.252.205 80
...
-----END PRIVATE KEY-----
  ...
  // VPNBook credentials (updated)
  static const String username = 'vpnbook';
  static const String password = 'm34wk9w';

  // Helper method to get the raw OVPN config for a specific server
  static String getRawOVPNConfig(String serverName) {
    switch (serverName) {
      case 'vpnbook-uk205-tcp80':
        return _vpnBookUKConfig;
      default:
        return _vpnBookUKConfig; // Default to UK config for demo
    }
  }
}